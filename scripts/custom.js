$(window).load(function () {
    ...
    //------------------------------------------------------------------------
    //						NAVBAR SLIDE SCRIPT & BTN TO TOP
    //------------------------------------------------------------------------ 		
...
$(document).ready(function () {
    ...
    //------------------------------------------------------------------------
    //					SUBSCRIBE FORM VALIDATION'S SETTINGS (ACTUAL)
    //------------------------------------------------------------------------          
    $('#subscribe_form').validate({
        ...
        messages: {
            email: {
                required: "Введите email для того, чтобы стать подписчиком",
	...
	//------------------------------------------------------------------------------------
    //						CALLBACK FORM VALIDATION'S SETTINGS
    //------------------------------------------------------------------------------------
	...
	$('#callback_form').submit(function() {
		if ($(this).valid()) {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    callbackname: $('#callback_name').val(),
                    callbackphone: $('#callback_phone').val()
                },
                success: function () {
